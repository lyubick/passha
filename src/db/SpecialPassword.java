...
public class SpecialPassword
{
    ...
    public SpecialPassword(HashMap<String, String> m) throws Exceptions
    {
        ...
        name = m.getOrDefault("name", "dflt");
        comment = m.getOrDefault("comment", "dflt");
        url = m.getOrDefault("url", "dflt");
        length = Integer.parseInt(m.getOrDefault("length", "0"));
        specialChars = m.getOrDefault("specialChars", "dflt");
        paramsMask = Utilities.getBitSet(m.getOrDefault("paramsMask", "dflt"));

        Logger.printDebug("shaCycles: " + shaCycles);
        Logger.printDebug("name: " + name);
        Logger.printDebug("comment: " + comment);
        Logger.printDebug("url: " + url);
        Logger.printDebug("length: " + length);
        Logger.printDebug("specialChars: " + specialChars);
        Logger.printDebug("paramsMask: " + paramsMask);
