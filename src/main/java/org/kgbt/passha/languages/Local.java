package org.kgbt.passha.languages;
...
public class Local
{
    public enum Texts
    {
        ...
        { "Legacy user file found.", "��������� ���������� ���� ������������." }),

        MSG_MIGRATION_ERRORS(new String[]
        { " password(s) failed to migrate.", " ������(��) �� ������� ���������." }),

        MSG_MIGRATION_SUCCESS(new String[]
        { "Successfully migrated user file.", "���� ������������ ������� ��������." }),
        ...
        { "There are unsaved passwords. Quit?", "���� ������������ ������. �����?" }),
        ...
        { Texts.LABEL_ERROR.toString() + " Shortcut is in use by: ", Texts.LABEL_ERROR.toString() + " ������� ������� ������: " }),
        ...
        { Texts.LABEL_ERROR.toString() + "One or more mandatory fields are missing.", Texts.LABEL_ERROR.toString() + "���� ��� ����� ������������ ����� �� ���������." }),
        ...
        { Texts.LABEL_ERROR.toString() + " Name already taken!", Texts.LABEL_ERROR.toString() + " ��� ��� ������!" }),
        ...
        { "Select path to save export file.", "�������� ���� ��� ���������� ����� ��������." }),
