...
public final class TestUtilities
{
    ...
    public static class SpecialPassword
    {
        ...
        public static boolean cmpAllFields(db.SpecialPassword sp, String name, String comment, String url, int length,
            int shaCycles)
        {
        ...
        public static boolean cmpAllFields(db.SpecialPassword sp, String name, String comment, String url,
            String length, String shaCycles)
        {
            return cmpAllFields(sp, name, comment, url, Integer.parseInt(length), Integer.parseInt(shaCycles));
        }

        public static boolean cmpAllFields(db.SpecialPassword sp, db.SpecialPassword another)
        {
